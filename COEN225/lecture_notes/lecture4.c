...
int main (void)
{
    ...
    char *cp1 = (char*) malloc(1);  //  1-12 has header:0x00000011, zero out last 3 bits length becomes 0x00000010 = 16
    // Malloc allocates memory starting with 16 bytes and 8 byte increments after that
    char *cp2 = (char*) malloc(12); 
    char *cp3 = (char*) malloc(13); // 13-20 has header:0x00000019, zero out last 3 bits length becomes 0x00000018 = 24
    char *cp4 = (char*) malloc(20);
    char *cp5 = (char*) malloc(21); // 21-28 has header:0x00000021, zero out last 3 bits length becomes 0x00000020 = 32
