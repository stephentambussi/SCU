#ELEN 285 Final Project - Stephen Tambussi
from math import floor
import pandas as pd
import matplotlib.pyplot as plt
import numpy as np

df_og = pd.read_csv(r"C:\Users\steve\Desktop\ELEN285\Final Project\csv\654.csv") #unmodified dataframe
...
plt.plot(np_load_weekdays, label="Power Load of Site during Weekdays")
#plt.plot(x_t, np_load_weekends, label="Power Load of Site during Weekends")
plt.plot(np_load_weekends, label="Power Load of Site during Weekends")
...
plt.plot(np_powervalue, label="Power Load of Site Every Day of Year")
...
event_times = [12, 13, 14, 15, 16, 17] #DR event from 12:00 to 18:00
...
plt.axvspan(144, 216, color='red', alpha=0.25, label="DR Event Activation")
plt.legend()
plt.show()
